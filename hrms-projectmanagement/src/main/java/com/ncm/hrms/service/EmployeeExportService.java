...
public class EmployeeExportService {
	...
	public void exportToCSV(List<EmployeeResponse> list, PrintWriter writer) {
		...
		for (EmployeeResponse e : list) {
			String designation = (e.getDesignation() != null) ? e.getDesignation().getTitle() : "";

			String hireDate = (e.getHireDate() != null) ? e.getHireDate().toString() : "";

			writer.println(e.getId() + "," + e.getName() + "," + e.getEmail() + "," + e.getPhoneNumber() + ","
					+ e.getEducation() + "," + e.getDateOfBirth() + "," + designation + "," + hireDate + ","
	...
	public void exportToExcel(List<EmployeeResponse> list, HttpServletResponse response) throws IOException {
		...
		String[] columns = { "ID", "Name", "Email", "Phone", "Education", "Status", "Role", "Designation",
		...
		for (EmployeeResponse e : list) {
			...
			String dob = (e.getDateOfBirth() != null) ? e.getDateOfBirth().toString() : "";
